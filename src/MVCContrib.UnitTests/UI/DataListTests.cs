...
namespace MvcContrib.UnitTests.UI.DataList
{
	...
	public class DataListTests
	{
		...
		public void Dictionary_on_table_should_sticks()
		{
			...
			Assert.AreEqual("<table id=\"foo\" class=\"bar\"><tr><td>test1</td></tr><tr><td>test2</td></tr></table>",
			                Writer.ToString());
		}
		...
		public void Can_render_content_vertically()
		{
			...
			Assert.AreEqual("<table><tr><td>1</td><td>3</td><td>5</td></tr><tr><td>2</td><td>4</td><td>6</td></tr></table>",
			                Writer.ToString());
		}
		...
		public void When_setting_CellAttributes_the_sttributes_it_Sticks()
		{
			...
			Assert.AreEqual(
				"<table><tr><td id=\"foo\" class=\"bar\">TEST1</td></tr><tr><td id=\"foo\" class=\"bar\">TEST2</td></tr></table>",
				Writer.ToString());
		}

		[Test]
		public void When_setting_attributes_they_should_be_encoded()
		{
			new DataList<string>(_datasource, Writer)
				.CellTemplate(x => { Writer.Write(x.ToUpper()); })
				.CellAttributes(id => "\"foo\"").ToString();

			string expected = "<table><tr><td id=\"&quot;foo&quot;\">TEST1</td></tr><tr><td id=\"&quot;foo&quot;\">TEST2</td></tr></table>";
			Writer.ToString().ShouldEqual(expected);
		}
		...
		public void Large_lists_render_correctly_with_RepeatColumns_not_set()
		{
			...
			Assert.AreEqual(
				"<table><tr><td>1</td></tr><tr><td>2</td></tr><tr><td>3</td></tr><tr><td>4</td></tr><tr><td>5</td></tr><tr><td>6</td></tr><tr><td>7</td></tr><tr><td>8</td></tr><tr><td>9</td></tr></table>",
				Writer.ToString());
		}
		...
		public void Large_lists_render_correctly_Vertically_with_non_even_columns()
		{
			...
			Assert.AreEqual(
				"<table><tr><td>1</td><td>4</td><td>7</td><td>10</td></tr><tr><td>2</td><td>5</td><td>8</td><td>11</td></tr><tr><td>3</td><td>6</td><td>9</td><td></td></tr></table>",
				Writer.ToString());
		}
